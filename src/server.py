...
# AIOQUIC-SERVER MAIN
# DECEMBER 2022
# tiré de https://github.com/aiortc/aioquic/blob/main/examples/http3_server.py#L16
# thx to aioquic


# Runway :
#	- Parse Args (l. 512)
#		- Run main (serve(...protocol...)) (l. 493)
#		- Retreive HttpProtocol (l. 338)
"""
...
SERVER_NAME = "aio.test" + aioquic.__version__
...
class HttpServerProtocol(QuicConnectionProtocol):
    ...
    def http_event_received(self, event: H3Event) -> None:
        ...
        if isinstance(event, HeadersReceived) and event.stream_id not in self._handlers:
            ...
            else: # TODO - implement http2 alt-svc header
...
async def main(
    ...
    print("Launching server : {}:{} \n".format(args.host,args.port)) #FLUSH
...
if __name__ == "__main__":
    ...
    if args.quic_log:
        ...
        quic_logger = QuicFileLogger("default_logfile")#QuicLoggerTrace(is_client=False, odcid=1)) # "=1" TODO
